...
- 默认使用中文回复；只有产品所有者明确要求时才切换语言。
- 先说明当前可见界面、可用功能、限制和下一项用户决策，再补充必要的代码证据。
- `README.md` 只解释当前仓库版本、当前入口和已经实现的能力，不放未来版本路线。
- 未来路线保留在项目内核、活动状态和 Obsidian 设计视图中，不复制到 README。
- 新对话框交接保持简短，依靠项目 skill、单一事实源和 route 恢复上下文，不粘贴长篇历史。

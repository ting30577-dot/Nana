...
> 当前状态为 `acceptance_pending`、`d3_complete=false`。旧的
> `d3-current-accepted` 只代表历史技术快照，不再是当前验收结论。
> 2026-08-17 技术证据已重新冻结为 Python 445/445、浏览器矩阵 27/27、
> 10/10 连续旅程和 212 项安装目录清单审计；这些客观证据不替代主观观察门。
